...
namespace Vektonn.Index.Faiss
{
    internal class FaissApi
    {
        ...
        [DllImport(@"libfaiss_c")]
        internal static extern int faiss_IDSelectorRange_new(ref IntPtr p_sel, long imin, long imax);

        // void faiss_IDSelectorRange_free(FaissIDSelectorRange* obj);
        [DllImport(@"libfaiss_c")]
        internal static extern void faiss_IDSelectorRange_free(IntPtr obj);
        ...
        [DllImport(@"libfaiss_c")]
        internal static extern void faiss_IDSelector_free(IntPtr obj); // todo: IDSelectorBatch_free
    }
}
