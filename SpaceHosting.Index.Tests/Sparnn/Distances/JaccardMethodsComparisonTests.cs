...
namespace SpaceHosting.Index.Tests.Sparnn.Distances
{
    ...
    public class JaccardMethodsComparisonTests
    {
        ...
        public void SetUp()
        {
            ...
            Func<Random> deterministicRngFactory = () => new Random(0);
            jaccardBinaryIndex = new SparnnIndex(deterministicRngFactory, new TestMatrixMetricSearchSpaceFactory(newVersion: false), indicesNumber, clusterSize, VectorSize);
            jaccardBinarySingleOrientedIndex = new SparnnIndex(deterministicRngFactory, new TestMatrixMetricSearchSpaceFactory(newVersion: true), indicesNumber, clusterSize, VectorSize);
